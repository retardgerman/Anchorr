...
export const COLORS = {
  SEARCH: 0xef9f76, // Peach - for search results
  SUCCESS: 0xa6d189, // Green - for successful operations
  ERROR: 0xf38ba8, // Red - for errors
  DEFAULT: 0xef9f76, // Peach - default color
  INFO: 0x89b4fa, // Blue - for informational messages
  WARNING: 0xf9e2af, // Yellow - for warnings
};
